...
(function (e) {
    ...
    window[e] = function (r, i, s) {
        ...
        var o = document.createElement("canvas").getContext("2d"), u = [new i.Matrix([0, 0], "1*2"), new i.Matrix([0, this.canvas.height], "1*2"), new i.Matrix([this.canvas.width, 0], "1 * 2"), new i.Matrix([this.canvas.width, this.canvas.height], "1*2")], a = [], f = new i.Matrix(t, "2*2");
        for (var l = 0; l < u.length; l++)a.push(u[l].mutiply(f));
        var c = Math.max(a[0].data[0][0], a[1].data[0][0], a[2].data[0][0], a[3].data[0][0]), h = Math.min(a[0].data[0][0], a[1].data[0][0], a[2].data[0][0], a[3].data[0][0]), p = Math.max(a[0].data[0][1], a[1].data[0][1], a[2].data[0][1], a[3].data[0][1]), d = Math.min(a[0].data[0][1], a[1].data[0][1], a[2].data[0][1], a[3].data[0][1]), v = ~~(c - h), m = ~~(p - d);
    ...
    window[e].module("addLayer", function (e) {
        var t = {add: function (e, t, n, r, i, s, o, u) {
            var a = e.data, f = t.data, i = i || 0, s = s || 0, r = r || 1, o = o || !1, u = u || "RGB";
            /[RGB]+/.test(u) || (u = "RGB");
            var l = u.replace("R", "0").replace("G", "1").replace("B", "2"), c = 1, h, p = e.width, d = e.height, v = f.length, m = t.width, g = t.height, y = [l.indexOf("0") > -1, l.indexOf("1") > -1, l.indexOf("2") > -1], b = 4 * c, w, E, S, x, T, N, C, k, L, A, O, M = i, _ = i + m, D = s, P = s + g;
            if (M > p)return;
            M < 0 && (M = 0);
            if (_ < 0)return;
            _ > p && (_ = p);
    ...
    window[e].module("applyMatrix", function (e) {
        var t = {process: function (t, n) {
            var r = n || .6, i = t.data, s = t.width, o = t.height, u = new e.lib.dorsyMath.Matrix([-2, -4, -4, -4, -2, -4, 0, 8, 0, -4, -4, 8, 24, 8, -4, -4, 0, 8, 0, -4, -2, -4, -4, -4, -2], 25, 1), a = [];
    ...
    window[e].module("dorsyMath", function (e) {
        var t = {FFT1: function (e) {
            ...
            i = i || 0;
            var s = n.data, o = n.width, u = n.height, a = r.length, f = new t.Matrix(r, a, 1), l = [], c = -(Math.sqrt(a) - 1) / 2;
            ...
            if (e <= Math.PI * 2 / 3)var r = n * (1 - t), i = n * (1 + t * Math.cos(e) / Math.cos(Math.PI / 3 - e)), s = 3 * n - (i + r); else if (e <= Math.PI * 4 / 3) {
                e -= Math.PI * 2 / 3;
        ...
        return t.Matrix.prototype = {plus: function (e) {
    ...
    window[e].module("dorsyWorker", function (e) {
        var t = 200, n = function (n) {
            ...
            var i = {queue: [], startWorker: function () {
                this.shiftAction()
    ...
    window[e].module("easy", function (t) {
        var n = {getFun: function (t) {
            var n = {softenFace: function () {
                var e = this.clone();
    ...
    window[e].module("Tools", function (e) {
        var t = {getColor: {process: function (t, n) {
            var r = e.lib.dorsyMath, i = r.xyToIFun(t.width), s, o = [0, 0, 0], u = 50, a = Math.PI * 2 / u, f, l = [];
            ...
            var y = p * a, b = r.HSIToRGB(y, v, g), w = "rgb(" + parseInt(b.R) + "," + parseInt(b.G) + "," + parseInt(b.B) + ")";
            return w
        }}, toText: {process: function (t, n) {
    ...
    window[e].module("Alteration.curve", function (e) {
        var t = {process: function (t, n) {
            ...
            /[RGB]+/.test(u) || (u = "RGB");
            var a = u.replace("R", "0").replace("G", "1").replace("B", "2"), f = [a.indexOf("0") > -1, a.indexOf("1") > -1, a.indexOf("2") > -1];
    ...
    window[e].module("Alteration.selectiveColor", function (e) {
        var t = {process: function (t, n) {
            var r = n[0], i = n[1], s = n[2], o = n[3], u = n[4], a = n[5] || 0, f = {red: "R", green: "G", blue: "B", "\u7ea2\u8272": "R", "\u7eff\u8272": "G", "\u84dd\u8272": "B"}, l = {cyan: "R", magenta: "G", yellow: "B", "\u9752\u8272": "R", "\u6d0b\u7ea2": "G", "\u9ec4\u8272": "B"}, c = function (e) {
            ...
            for (var m = 0, g = t.width; m < g; m++)for (var y = 0, b = t.height; y < b; y++)e.lib.dorsyMath.xyCal(t, m, y, function (e, t, n) {
                ...
                if (c(i)) {
                    ...
                    for (var g = 0; g < 3; g++) {
                        var y = parseInt(d * (s[g] / 255)), b = s[g] - y, w = parseInt(d * (1 - s[g] / 255)), E = s[g] + w, S = v[g] + u + v[g] * u;
                        if (a) {
                            s[g] > 128 && (y = w);
    ...
    window[e].module("Filter.ImageEnhance", function (e) {
        var t = {process: function (e, t, n) {
            function f(e) {
            }

            var r = arg || .5, i = e.data, s = e.width, o = e.height, u = t || {x: 10, y: 10}, a = n || {x: 50, y: 40};
    ...
    window[e].module("Filter.corrode", function (e) {
        var t = {process: function (e, t) {
            ...
            for (var u = 0; u < i; u++)for (var a = 0; a < s; a++) {
                var f = parseInt(Math.random() * n * 2) - n, l = parseInt(Math.random() * n * 2) - n, c = a * i + u, h = (a + f) * i + u + l;
    ...
    window[e].module("Filter.darkCorner", function (e) {
        var t = {process: function (t, n) {
            ...
            var r = parseInt(n[0]) || 3, i = n[2] || "round", s = n[1] || 30, o = t.data, u = t.width, a = t.height, f = r * 2 + 1, l = u * 2 / 3, c = a * 1 / 2, h = e.lib.dorsyMath.distance([l, c]), p = h * (1 - r / 10), d = function (e, t, n, r, i) {
    ...
    window[e].module("Filter.dotted", function (e) {
        var t = {process: function (t, n) {
            var r = parseInt(n[0]) || 1, i = parseInt(n[1]) || 1, s = t.data, o = t.width, u = t.height, a = r * 2 + 1, f = [], l = i * i;
    ...
    window[e].module("Filter.embossment", function (e) {
        var t = {process: function (e, t) {
            ...
            for (var o = 0, u = n.length; o < u; o += 4) {
                var a = o / 4, f = parseInt(a / r), l = a % r, c = ((f - 1) * r + (l - 1)) * 4, h = (f + 1) * r * 4 + (l + 1) * 4;
                if (f == 0 || l == 0)continue;
    ...
    window[e].module("Filter.borderline", function (e) {
        var t = {process: function (t, n) {
            var r = [-2, -4, -4, -4, -2, -4, 0, 8, 0, -4, -4, 8, 24, 8, -4, -4, 0, 8, 0, -4, -2, -4, -4, -4, -2], i = [0, 1, 0, 1, -4, 1, 0, 1, 0], s = [];
